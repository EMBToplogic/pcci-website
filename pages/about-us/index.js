      ...
      <div className='subpage_container'>
        <div className='subpage_inner_container'>
          ...
          <div className='subpage_paragraph'>
            ...
            and industry associations representing various sectors of business,
            all working together to foster a healthier Philippine economy and
            improve the viability of business in the community.
          </div>
          <div className='subpage_paragraph'>
          ...
          <div className='subpage_paragraph'>
            ...
            services for the advancement of grassroots entrepreneurship, chamber
            development, international trade relations, business innovation and
            excellence, and operating efficiency. These will be achieved through
            a professional organization working in close cooperation with
            various stakeholders in public and private sectors. ​
          </div>
          ...
          <div className='subpage_paragraph'>
            To operationalize its MISSION and VISION, PCCI adopts the following
            strategic thrusts:
          </div>

          <ul className='ul_secondary'>
            <li>
              Steadfast support for the promotion and growth of micro, small and
              medium enterprises nationwide;
            </li>
            <li>
              Pioneer policy reform initiatives to improve the business climate
