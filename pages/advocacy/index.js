      ...
      <div className='subpage_container'>
        <div className='subpage_inner_container'>
          ...
          <div className='subpage_paragraph'>
            PCCI works closely with key government and legislative bodies in the
            formulation, development, implementation, and evaluation of
            government plans, policies, and programs through the PCCI Sectoral
            Committees. Membership in these committees, however, is a privilege
            granted only to PCCI members. It keeps everyone abreast with the
            issues besetting one’s industry or sector. Here, one gets a chance
            to directly influence the decision-making process within the context
            and realities of Philippine business and politics. ​
          </div>
